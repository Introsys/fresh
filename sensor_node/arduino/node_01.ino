...
#define SENSOR_TEMP_1_PIN 2 //AN2
#define SENSOR_TEMP_2_PIN 2 //DI2
#define SENSOR_TEMP_2_TYPE DHT22 //DHT 22 (AM2302)
#define SENSOR_CO2_ANALOG_PIN 3 //AN3
#define SENSOR_CO2_BOOL_PIN 7 //DI7

#define DEVICE_TYPE "Zone"
#define DEVICE_ID "Zone2"
...
DFR_CO2 sensor_co2 = DFR_CO2(SENSOR_CO2_ANALOG_PIN, SENSOR_CO2_BOOL_PIN);
...
void loop()
{
  ...
  float val = sensor_co2.readValue();
  int percent = sensor_co2.getPercentage(val);
  char s_co2[32];
  if(percent == -1)
  {
    strcpy(s_co2, "400");
